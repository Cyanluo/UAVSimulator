...
from pegasus.simulator.logic.backends.coax_ardupilot_backend import CoaxArduPilotBackend
...
class PegasusApp:
    ...
    def __init__(self):
        ...
        backend_config = ArduPilotMavlinkBackendConfig({
            ...
            "ardupilot_data_path": os.path.join(os.path.dirname(os.path.abspath(__file__)), "apm_data"),
            "ardupilot_vehicle_model": "coaxcopter",
            "num_rotors": 6,
        ...
        config_coaxcopter.backends = [
            CoaxArduPilotBackend(config=backend_config),
        ...
        self.pg.set_viewport_camera([11.0, 8.0, 2], [3.3, 0.0, 0.3])
